...
var ChatProvider = /** @class */ (function () {
    ...
    ChatProvider.prototype.getLobby = function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (user) {
                            ...
                            return [2 /*return*/, this._lobby];
                        }
                        console.log(FirebaseChatConfigs_1.FirebaseChatConfigs.getInstance().getMyParticipantToken() || "");
