...
var Room = /** @class */ (function () {
    function Room(id, name, image, participants, messages, meta_data, last_message) {
        ...
        this.getRoomName = function () {
            ...
            var makeName = "";
            var length = _this.participants.length > 3 ? 3 : _this.participants.length;
            var endText = _this.participants.length > 3 ? ", ..." : "";
    ...
    Room.prototype.getRoomListener = function () {
        ...
        this._dbr.child(this.getRoomLink()).on("value", function (snapshot) {
            _this.setRoomFromSnapshot(snapshot);
    ...
    Room.prototype.setRoomFromSnapshot = function (snapshot) {
        var room = class_transformer_1.plainToClass(Room, snapshot.val());
        var msgs = new Array();
        if (snapshot.val()["messages"] != null) {
            var messageObj = snapshot.val()["messages"];
